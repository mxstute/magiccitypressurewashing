...
const PW_SERVICES = [
  { icon: "🏠", name: "House Washing", desc: "Soft wash for siding, stucco, brick & painted surfaces" },
  { icon: "🚗", name: "Driveway & Sidewalk", desc: "High-pressure surface cleaning for concrete & pavers" },
  { icon: "🏊", name: "Pool Decks & Patios", desc: "Remove algae, mold, and staining from outdoor surfaces" },
  { icon: "🏗️", name: "Roof Soft Wash", desc: "Safe chemical treatment for shingle & tile roofs" },
  { icon: "🏢", name: "Commercial Properties", desc: "Storefronts, parking lots, common areas" },
  { icon: "🧱", name: "Fences & Walls", desc: "Restore wood, vinyl, and concrete fences" },
];
...
export default function PressureWashingSite() {
    ...
    <div style={{ minHeight: "100vh", background: "#0B1120", color: "#F8FAFC", fontFamily: "'Outfit', sans-serif", overflowX: "hidden" }}>
      ...
      <nav style={{
        ...
        <div style={{ display: "flex", alignItems: "center", gap: "10px" }}>
          <div style={{ width: "32px", height: "32px", borderRadius: "8px", background: "#0B1120", display: "flex", alignItems: "center", justifyContent: "center", border: "1px solid rgba(125,211,252,0.2)" }}>
            <div style={{ display: "flex", gap: "2px", alignItems: "flex-end" }}>
              {[10, 16, 12, 18].map((h, i) => (
                <div key={i} style={{ width: "4px", height: `${h}px`, borderRadius: "1px", background: i % 2 === 0 ? "#7DD3FC" : "linear-gradient(180deg, #7DD3FC, #F472B6)" }} />
              ))}
            </div>
          </div>
          <div>
            <div style={{ fontSize: "12px", fontWeight: 700, letterSpacing: "0.5px" }} className="nav-logo-text">MAGIC CITY</div>
            <div style={{ fontSize: "7px", color: "#94A3B8", letterSpacing: "2px" }} className="nav-sub-text">PRESSURE WASHING</div>
          </div>
        </div>
        ...
        <div style={{ display: "flex", justifyContent: "flex-end" }}>
          <a onClick={trackPhoneClick} href="tel:3057833133" className="phone-btn" style={{
      ...
      <section style={{ padding: "55px 20px 45px", textAlign: "center", background: "linear-gradient(180deg, #0B1120 0%, #131B2E 100%)" }}>
        ...
        <h1 style={{ fontFamily: "'Playfair Display', serif", fontSize: "clamp(30px, 6vw, 48px)", fontWeight: 700, lineHeight: 1.15, margin: "0 0 16px" }}>
          Miami's Premier{"\n"}
          <span style={{ background: "linear-gradient(135deg, #7DD3FC, #F472B6)", WebkitBackgroundClip: "text", WebkitTextFillColor: "transparent" }}>
            Pressure Washing
          </span>
        </h1>

        <p style={{ fontSize: "16px", color: "#94A3B8", maxWidth: "480px", margin: "0 auto 24px", lineHeight: 1.6 }}>
          Driveways, house exteriors, roofs, pool decks — commercial-grade equipment, professional results. Same-day service available.
        </p>
      ...
      <section style={{ padding: "40px 16px 50px", background: "linear-gradient(180deg, #131B2E 0%, #0B1120 100%)" }}>
        <div style={{ maxWidth: "560px", margin: "0 auto" }}>
          <div style={{ textAlign: "center", marginBottom: "24px" }}>
            <h2 style={{ fontFamily: "'Playfair Display', serif", fontSize: "26px", fontWeight: 700, margin: "0 0 6px" }}>Book Your Wash</h2>
            ...
            <div style={{ padding: "24px 20px", borderRadius: "16px", background: "rgba(30,41,59,0.3)", border: "1px solid rgba(148,163,184,0.1)" }}>
              ...
              {PACKAGES.map((pkg, i) => (
                <button key={i} className="pkg-card" onClick={() => setSelectedPkg(i)}
                  ...
                  {pkg.tag && (
                    <div style={{ position: "absolute", top: 0, right: 0, padding: "2px 10px", borderRadius: "0 10px 0 8px", background: "rgba(34,197,94,0.2)", fontSize: "9px", fontWeight: 700, color: "#22C55E" }}>{pkg.tag}</div>
                  )}
                  <div>
                    <div style={{ fontSize: "13px", fontWeight: 600, color: selectedPkg === i ? "#7DD3FC" : "#F8FAFC" }}>{pkg.name}</div>
                    <div style={{ fontSize: "10px", color: "#94A3B8", marginTop: "2px" }}>{pkg.note}</div>
                  </div>
                  <div style={{ textAlign: "right", flexShrink: 0 }}>
                    <div style={{ fontSize: "15px", fontWeight: 700, color: "#7DD3FC" }}>{pkg.price}</div>
          ...
          {bookingTab === "call" && (
            <div style={{ padding: "30px 20px", borderRadius: "16px", textAlign: "center", background: "rgba(30,41,59,0.3)", border: "1px solid rgba(148,163,184,0.1)" }}>
              ...
              <br />
              <a onClick={trackPhoneClick} href="tel:3057833133" style={{ display: "inline-block", padding: "14px 32px", borderRadius: "12px", background: "linear-gradient(135deg, #7DD3FC, #38BDF8)", color: "#0B1120", fontSize: "18px", fontWeight: 700, textDecoration: "none", fontFamily: "inherit" }}>(305) 783-3133</a>
      ...
      <section style={{ padding: "50px 16px", background: "linear-gradient(180deg, #131B2E 0%, #0B1120 100%)" }}>
        <h2 style={{ fontFamily: "'Playfair Display', serif", fontSize: "26px", textAlign: "center", marginBottom: "24px" }}>What We <span style={{ color: "#7DD3FC" }}>Clean</span></h2>
      ...
      <section style={{ padding: "50px 16px", background: "linear-gradient(180deg, #0B1120 0%, #131B2E 100%)" }}>
        <h2 style={{ fontFamily: "'Playfair Display', serif", fontSize: "26px", textAlign: "center", marginBottom: "24px" }}>Areas We <span style={{ color: "#7DD3FC" }}>Serve</span></h2>
        <div style={{ display: "flex", flexWrap: "wrap", gap: "8px", justifyContent: "center", maxWidth: "600px", margin: "0 auto" }}>
          {AREAS.map((area, i) => (
            <span key={i} onMouseEnter={() => setHoveredArea(i)} onMouseLeave={() => setHoveredArea(null)}
              style={{ padding: "8px 16px", borderRadius: "20px", border: hoveredArea === i ? "1px solid #7DD3FC" : "1px solid rgba(148,163,184,0.15)", background: hoveredArea === i ? "rgba(125,211,252,0.1)" : "rgba(30,41,59,0.3)", color: hoveredArea === i ? "#7DD3FC" : "#94A3B8", fontSize: "12px", fontWeight: 500, cursor: "pointer", transition: "all 0.2s" }}
            >{area}</span>
          ))}
        </div>
      </section>
      ...
      <section style={{ padding: "30px 16px", background: "linear-gradient(180deg, #131B2E 0%, #0B1120 100%)", textAlign: "center" }}>
        ...
        <div style={{ display: "flex", gap: "10px", justifyContent: "center", flexWrap: "wrap" }}>
          {[{ name: "Junk Removal", link: "magiccityjunkremovalmiami.com" }, { name: "Mobile Detailing", link: "magiccitydetailingmiami.com" }].map((s, i) => (
            <a key={i} href={`https://${s.link}`} target="_blank" rel="noopener noreferrer" style={{ padding: "10px 20px", borderRadius: "10px", background: "rgba(30,41,59,0.4)", border: "1px solid rgba(148,163,184,0.1)", textDecoration: "none", color: "#7DD3FC", fontSize: "13px", fontWeight: 500 }}>{s.name} →</a>
          ))}
        </div>
      </section>
      ...
      <footer id="footer" style={{ padding: "30px 16px", textAlign: "center", borderTop: "1px solid rgba(148,163,184,0.1)", background: "#0B1120" }}>
        ...
        <a onClick={trackPhoneClick} href="tel:3057833133" style={{ fontSize: "14px", color: "#7DD3FC", textDecoration: "none", fontWeight: 600 }}>(305) 783-3133</a>
        <br />
